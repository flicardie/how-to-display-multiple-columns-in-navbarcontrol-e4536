...
Namespace NavBarExample
    Partial Public Class MyNavBarControl
        ...
        Public Sub New()
            InitializeComponent()
            AddHandler Me.ControlAdded, AddressOf MyNavBarControl_ControlAdded
            AddHandler Me.ControlRemoved, AddressOf MyNavBarControl_ControlRemoved
            AddHandler Me.Resize, AddressOf MyNavBarControl_Resize
        ...
        Public Sub ArrGroupItem(ByVal barIndex As Integer, ByVal groupName As String, ByVal itemName As String)
            ...
            item.SmallImageIndex = (imageIndexer) Mod (images.Images.Count - 1)
            imageIndexer += 1
